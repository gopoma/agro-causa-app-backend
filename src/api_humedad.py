...
origins = [
    "http://localhost",
    "http://localhost:5173",  # Origen de tu aplicación en desarrollo
    "http://52.90.81.157:8000",  # Tu API pública (o la IP pública del servidor)
    "*",  
]
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=origins,  # Permitir los orígenes configurados
...
ruta = "/app/data/SMAP_L4_SM_aup_20240926T030000_Vv7031_001.h5"
